...
export function HomePage() {
  ...
  return (
    <div className="space-y-16">
      ...
      >
        <div className="text-center space-y-4">
          <h2 className="text-3xl font-bold">适用场景</h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            无论是个人的关系维护，还是工作的沟通优化，都能找到合适的分析方案
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {useCases.map((useCase, index) => (
            <motion.div
              ...
              className="p-6 rounded-lg border hover:border-primary/50 transition-all duration-300"
            >
              <div className="space-y-4">
      ...
      >
        <div className="text-center space-y-4">
          <h2 className="text-3xl font-bold">技术优势</h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            基于先进的技术架构，提供高效、准确、安全的分析服务
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            <div className="mx-auto p-4 rounded-full bg-blue-50 w-fit">
              <Brain className="h-8 w-8 text-blue-600" />
            </div>
            <div>
              <h3 className="font-semibold text-lg mb-2">AI 驱动</h3>
              <p className="text-muted-foreground">
                采用最新的自然语言处理技术，提供深度语义分析
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              <h3 className="font-semibold text-lg mb-2">实时处理</h3>
              <p className="text-muted-foreground">
                支持大规模数据处理，实时监控分析进度
              </p>
            </div>
          ...
          <motion.div
            ...
            className="text-center space-y-4"
          >
            <div className="mx-auto p-4 rounded-full bg-purple-50 w-fit">
      ...
      <motion.section
        ...
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 0.4 }}
        className="text-center space-y-6 py-12 px-6 rounded-lg border bg-gradient-to-r from-primary/5 to-primary/10"
      >
        <div className="space-y-4">
          <h2 className="text-3xl font-bold">开始你的分析之旅</h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            选择聊天对象，配置分析参数，让 AI 为你揭示聊天记录中的隐藏洞察
          </p>
        </div>
